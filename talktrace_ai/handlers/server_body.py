...
"""
from . import start, onboarding, sidebar, analysis, noscribe, consent, results, feedback, options, info
...
def register(state):
    ...
    noscribe.register(state)
    consent.register(state)
    results.register(state)
    feedback.register(state)
