STRINGS = {
    ...
    "options": {
        ...
        "localmind_fetch_button": "Load LocalMind models",
        "localmind_fetch_hint": "Fetches the current model list from api.lminference.eu (requires a saved LocalMind API key) and replaces the existing LocalMind models.",
        "localmind_fetch_no_key": "Please save a LocalMind API key first.",
        "localmind_fetch_empty": "No models received from LocalMind.",
        "localmind_fetch_success": "Loaded {n} LocalMind models.",
        "localmind_fetch_error": "Could not load LocalMind models: {error}",
